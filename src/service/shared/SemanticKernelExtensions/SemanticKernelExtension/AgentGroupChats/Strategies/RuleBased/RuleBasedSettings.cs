...
#pragma warning restore SKEXP0110
    {
        ...
        /// </param>
        public RuleBasedSettings(IEnumerable<RuleBasedDefinition> ruleBasedDefinitions)
        {
            ...
            SelectionStrategy = new RuleBasedSelectionStrategy(this);

            // Initialize the termination strategy using the current settings.
            TerminationStrategy = new RuleBasedTerminationStrategy(this);
        }
    }
}
